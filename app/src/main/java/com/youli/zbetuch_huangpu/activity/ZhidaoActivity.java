...
//                        lv.setVisibility(View.GONE);
    ...
    private void initView(){
        lv= (PullToRefreshListView) findViewById(R.id.lv_zhidao_info_list);
    ...
    private void getNetWorkData(final int page){
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String url= MyOkHttpUtils.BaseUrl+"/Json/CYWork/Get_CYWorkInfo.aspx?page="+page+"&rows=10&HDFL=培训活动管理";
